              ...
              <td>
                ...
                <?php if (!empty($p['pagado'])): ?>
                  <?php
                    ...
                    // Fecha corta (línea debajo del badge)
                    ...
                    // Relativo opcional (ej: "hace 2 min")
                  ...
                  <?php if ($pagadoAt): ?>
                    <div class="small text-muted">
                      <?= esc($fechaCorta) ?>
                      <span class="text-muted">(<?= esc($rel) ?>)</span>
                    </div>
                  <?php endif; ?>
                <?php else: ?>
...
<?php if (session('showFacturaDiaModal')): ?>
<script>
  document.addEventListener('DOMContentLoaded', function () {
    new bootstrap.Modal(document.getElementById('facturaDiaModal')).show();
  });
</script>
<?php endif; ?>
